...
import com.bytedance.todolist.database.TodoListDao_Impl;
    ...
    protected void onActivityResult(int requestCode, final int resultCode, final Intent data) {
        ...
        switch (requestCode) {
            case 1:
                    ...
                    {
                        String returnedData = data.getStringExtra("activity");

                        Log.d("Todo", returnedData);

                        loadFromDatabase();

                        Snackbar.make(mFab, R.string.real_hint_insert_complete, Snackbar.LENGTH_SHORT).show();
                    }
                break;
            default:
        }
